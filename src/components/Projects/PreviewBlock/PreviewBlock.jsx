...
function PreviewBlock ({ title, titleEyebrow, text, wrapperClass, bgClass, backgroundImage, gridClass, image, github, liveSite, liveSiteBtn, versions = [] }) {
        ...
        <section className={`preview-block-content ${bgClass || 'dark-bg black-bg'}`} style={{backgroundImage: `url(${backgroundImage})`}}>
            <div className={`${wrapperClass || 'full-wrapper'}`}>
                ...
                <div className={`${gridClass || 'grid-d-two-cols grid-d-reverse'}`}>
                    ...
                    {image && <FadeIn direction="up" duration={1} delay={0.6} className="center-img"><img src={image} /></FadeIn>}
                        ...
                        <div className="grid">
                            ...
                            {liveSite && 
                                <FadeIn direction="up" duration={1} delay={0.6}>
                                    <Link className="btn btn-primary" to={liveSite} target="_blank">
                            ...
                            {github && 
                                <FadeIn direction="up" duration={1} delay={0.6}>
                                    ...
                                    <Link className="btn btn-outline" to={github} target="_blank">                                        
